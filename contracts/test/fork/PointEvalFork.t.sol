...
/// Test-plan Layer 4 (fork half): the exact fixture suite — real c-kzg opening through
/// declareFor, wrong-y rejection — re-run against a mainnet fork, so the precompile
/// exercised is the forked chain's, not just the local EVM's.
///
